<!-- Trang quản lý độc giả cho quản trị viên/thủ thư -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Quản lý tác giả - Librio</title>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/frontend/assets/css/admin/manageReader.css?v=1.0">
</head>
<body>
