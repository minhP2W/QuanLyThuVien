<!-- Trang lập phiếu mượn sách, đặt trước sách cho thủ thư -->
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Quản lý sách - Librio</title>
    ...
    <link rel="stylesheet" href="<?= BASE_URL ?>/frontend/assets/css/admin/borrow_admin.css?v=1.0">
</head>
<body>
